                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b30">Remote work can lead to a better work-life balance. A flexible work schedule means there’s more time for family and personal projects. This in turn helps with stress and prevents burn-outs.</p>
                            <h2 class="heading-4 has-margin-b15">No commute</h2>
                            ...
                            <p class="has-margin-b30">What’s even worse, is that most companies don’t write off time spent commuting to and from work. This means that all those hours are deducted from time we would otherwise spend with family, friends and hobbies.</p>
                            <h2 class="heading-4 has-margin-b15">Health</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Less overhead</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Endless pool of talent</h2>
                            ...
                            <p class="has-margin-b30">If you’re working remotely, you can access qualified professionals from anywhere. Are you not finding the right team member in your town? No problem, look around in other cities, or even countries!</p>
                            <h2 class="heading-4 has-margin-b15">Higher efficiency</h2>
                            ...
                            <p class="has-margin-b30">We’re not all the same. Some of us are early birds, others are night owls. With a little extra organization, it’s possible to allow everyone to work when they are most efficient.</p>
                            <h2 class="heading-4 has-margin-b15">Trust and loyalty</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Self-discipline</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Communication</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Knowledge sharing</h2>
                            ...
                            <h2 class="heading-4 has-margin-b15">Personal relationships</h2>
