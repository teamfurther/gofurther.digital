                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">On the other hand, an outside-in approach dictates that we should first talk to our potential customers before planning and building anything. Steve Blank, the author of The Four Steps to Epiphany, once <a href="https://steveblank.com/2010/04/08/no-plan-survives-first-contact-with-customers-%E2%80%93-business-plans-versus-business-models/" target="_blank">famously said</a> that "no plan survives first contact with customers". Blank urges his readers to "get out of the building" and start talking to potential customers about the problems (not the solution!) we are aiming to solve. Let's see <a href="https://www.chameleon.io/blog/what-is-ux-research" target="_blank">how we can do that in practice</a>.</p>
