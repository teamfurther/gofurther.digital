                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>We have to show our <a href="{{ localizedRoute('blog.show', ['slug' => 'how-to-use-the-value-proposition-canvas']) }}">value proposition</a>, key advantages and functions of our product. What is even more important is to display the price of our product and a buy button. Yes, a buy button. Even if we don't have a product yet.</p>
                            ...
                            <p>What metrics can we use to validate these? I will dedicate <a href="{{ localizedRoute('blog.show', ['slug' => 'how-to-measure-the-success-of-your-startup']) }}" target="_blank">a separate article</a> to metrics, but let's take a quick look at the most important ones right now. Before jumping in, though, I would like to point out one of the major mistakes startups make: they fail to resist the temptation of metrics magic.</p>
                            ...
                            <p class="has-margin-b60">To grow, most startups should focus on decreasing their CAC. If CAC doesn't drop in time, it's a good sign that our business model will not be sustainable long term. In some cases, though, especially when employing a <a href="{{ localizedRoute('blog.show', ['slug' => 'lets-build-an-engine-of-growth']) }}" target="_blank">paid growth engine</a>, it can be acceptable for the CAC to remain consistent with the early values. Still, even then, a downwards trend is desirable.</p>
                            ...
                            <p class="has-margin-b60">Moreover, it's always cheaper to upsell existing customers' products or services than approaching cold leads since we have already established a rapport with them. When employing a <a href="{{ localizedRoute('blog.show', ['slug' => 'lets-build-an-engine-of-growth']) }}" target="_blank">sticky growth engine</a>, the churn rate will be one of our foremost metrics.</p>
                            ...
                            <p class="has-margin-b60">The referral rate, or RR, is closely related to NPS. RR is the % of total sales, which come from the referral of active users. The better our NPS, the more likely we will have a high RR. RR will be our most important metric if using a <a href="{{ localizedRoute('blog.show', ['slug' => 'lets-build-an-engine-of-growth']) }}" target="_blank">viral growth engine</a>.</p>
