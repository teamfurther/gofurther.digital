                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>When doing a zoom-in pivot, our prior experiments probably show that our <a href="{{ localizedRoute('blog.show', ['slug' => 'how-to-use-the-value-proposition-canvas']) }}">value proposition</a> stems from a single feature of our product. We should focus 100% of our attention on this feature during such a pivot.</p>
                            ...
                            <p>There are <a href="{{ localizedRoute('blog.show', ['slug' => 'lets-build-an-engine-of-growth']) }}" target="_blank">three distinct engines of growth</a> startups can employ: viral, sticky and paid. During this pivot type, startups jump between these engines to achieve faster or more profitable growth.</p>
    ...
    <script type="application/ld+json">
{
    ...
    "image": {
        ...
        "height": 630,
        "width": 1200,
        "url": "{{ route('generate-cover', ['title' => 'To Pivot or Not to Pivot – That Is the Question']) }}"
    },
    "inLanguage": "en_gb",
