                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Single Player Mode is terminology borrowed from the world of video games. Marketplaces are by default „multiplayer”. But 34% of marketplaces also adopt some single-player mode <a href="{{ localizedRoute('blog.show', ['slug' => 'how-to-use-the-value-proposition-canvas']) }}" target="_blank">value proposition</a>.</p>
