...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-laraconeu-madrid-2019.png') }}" srcset="{{ asset('media/blog/featured-laraconeu-madrid-2019-769w.png') }} 769w" sizes="100vw" alt="Further@LaraconEU Madrid 2019" />
    </div>
