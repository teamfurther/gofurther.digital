                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">In <a href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt2-company-culture']) }}">part two</a> and <a href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt2-company-culture']) }}">part three</a> we showed you how company culture and business processes can stand in the way of digital transformation. In this final part, we'll tackle the final piece of the puzzle and look at what technology you can leverage to take your business one step further.</p>
                            ...
                            <p>In our experience, an <a href="{{ localizedRoute('services') }}">integrated software system</a> has similar break-even points. Reports by our clients said they recovered their investments on average in a little over 2 years. Considering that an industrial robot has a service life of 12 years, one might argue that investing in software is even more profitable.</p>
                            ...
                            <p class="has-margin-b60"><em>If you enjoyed our series on digital transformation, <a href="{{ localizedRoute('contact') }}">get in touch</a>. We're always willing to chat about this topic.</em></p>
                            <div class="has-text-centered">
                                <a class="btn is-pearl has-margin-b15" href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt3-business-processes']) }}">&laquo; Pt. 3 - Business Processes</a>
                            </div>
                        </div>
                        <div class="column is-1-tablet is-2-desktop">
                            @include(getLang() . '.blog.includes.share', ['slug' => $slug, 'title' => 'Digital Transformation Pt. 4 - IT'])
                        </div>
                    </div>
                </div>
            </div>
...
<script type="application/ld+json">
{
    ...
    "image": {
        ...
        "height": 630,
        "width": 1200,
        "url": "{{ route('generate-cover', ['title' => 'Digital Transformation Series Pt. 4 - IT']) }}"
    },
    "inLanguage": "en_gb",
