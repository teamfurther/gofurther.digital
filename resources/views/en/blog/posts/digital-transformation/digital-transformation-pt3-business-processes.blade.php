                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">In <a href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt2-company-culture']) }}">part two of our series</a> we saw that the foundation of digital transformation is a strong digital culture within the team. But how should we change our processes to aid this cultural shift?</p>
                            ...
                            <div class="has-text-centered">
                                <a class="btn is-pearl has-margin-b15" href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt2-company-culture']) }}">&laquo; Pt. 2 - Company Culture</a>
                                <a class="btn is-pearl has-margin-b15" href="{{ localizedRoute('blog.show', ['slug' => 'digital-transformation-pt4-it']) }}">Pt. 4 - IT &raquo;</a>
                            </div>
                        </div>
...
<script type="application/ld+json">
{
    ...
    "image": {
        ...
        "height": 630,
        "width": 1200,
        "url": "{{ route('generate-cover', ['title' => 'Digital Transformation Series Pt. 3 - Processed']) }}"
    },
    "inLanguage": "en_gb",
