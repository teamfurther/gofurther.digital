                    ...
                    <div class="columns">
                        <div class="column">
                            ...
                            <div class="post__meta">
                                <time class="dt-published" datetime="2021-03-17 10:00:00">Apr 29th, 2021</time> &middot; 10 min read
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>The third stage in our product development journey will be searching for solution-product fit. As the name implies, in this stage we are going to look to prove that our product efficiently delivers the already validated solution.</p>
                            <p>As was the case with the previous two stages, I am going to use our imaginary product to illustrate the tools we have in the build-measure-learn loop, that we can use to prove solution-product fit.</p>
                            <p>If you missed out, we’re developing a gadget equipped with multiple sensors which can be attached to micromobility vehicles. Like a bike, an e-scooter or even a skateboard. When approaching an obstacle or sensing danger (motor vehicles, pedestrians, crosswalks, etc.), our gadget will emit sound and vibration alerts to keep us safe while travelling.</p>
                            ...
                            <p>Of course, the plans and visualization have other uses as well, since the contractor uses them to build the house. But this isn’t different with our product either. The technical drawings and 3D models are also going to be used in later prototypes and in building the final product.</p>
                            ...
                            <p>The first prototype will be rough representations of the product. These are called low-fidelity prototypes. Later on, as we refine them, they will more closely resemble the final product. Those will be called high-fidelity prototypes.</p>
                            ...
                            <p>As I mentioned, high-fidelity prototypes are refined versions of their low-fidelity counterparts. The most frequently used high-fidelity prototype is the <strong>mockup</strong>, which for a physical product can be scaled down or full-size representation of the product. In our case, this can be the shell of the gadget, in its final size, materials and colours, but empty on the inside. The difference between the mockup and the finite product will be that the mockup won’t be functional.</p>
