...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-the-lean-product-process-3-en.png') }}" srcset="{{ asset('media/blog/featured-the-lean-product-process-3-768w-en.png') }} 768w, {{ asset('media/blog/featured-the-lean-product-process-3-1000w-en.png') }} 1000w" sizes="100vw" alt="The Lean Product Process: #3 Creating Your Prototype" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">We can differentiate <a href="{{ localizedRoute('blog.show', ['slug' => '11-ways-to-build-an-mvp-pt1']) }}" target="_blank">lot's of prototypes</a>, let's see which of these can we encounter most often in the solution-product fit stage.</p>
