                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>When <a href="{{ localizedRoute('blog.show', ['slug' => 'the-lean-product-process-pt2']) }}">in this phase</a>, we already know that the problem we discovered is meaningful for others as well and they are actively looking for a solution, but we are not sure that our solution truly solves the problem for them.</p>
                            ...
                            <p>Once <a href="{{ localizedRoute('blog.show', ['slug' => 'the-lean-product-process-pt3']) }}">in this phase</a>, we already have a validated problem and solution. The question that remains to be answered is if we can actually develop a product that delivers this solution effectively.</p>
                            ...
                            <p>This is <a href="{{ localizedRoute('blog.show', ['slug' => 'the-lean-product-process-pt4']) }}">the last stage</a> of our product development. At this stage we already know that our product delivers the solution to our problem effectively, but we still don't know if our business model is sustainable.</p>
