...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-remote-corporate-culture-5-en.png') }}" srcset="{{ asset('media/blog/featured-remote-corporate-culture-5-768w-en.png') }} 768w, {{ asset('media/blog/featured-remote-corporate-culture-5-1000w-en.png') }} 1000w" sizes="100vw" alt="Bridging the distance gap with remote employees" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Long reports are not the goal here. If there is a problem that needs to be discussed in detail, a separate meeting should be arranged. The purpose of the stand-up is to help each participant to see the current status and progress of a project.</p>
                            ...
                            <h3 class="heading-4 has-margin-b15">The right tool for the task</h3>
                            <p>Contrary to popular belief, tools do matter. There are many tools available to help you organize and facilitate the work of a remote team.</p>
                            ...
                            <p>At Further it has become a tradition to organize half-year team buildings.</p>
