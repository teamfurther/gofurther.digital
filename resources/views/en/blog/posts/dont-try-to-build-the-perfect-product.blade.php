...
@section('description', 'In today\’s article, we will illustrate through a concrete example why it is not worth building a perfect product.')
                    ...
                    <div class="columns">
                        <div class="column">
                            ...
                            <div class="post__meta">
                                <time class="dt-published" datetime="2020-07-14 12:00:00">Jun 14, 2020</time> &middot; 6 min read
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>The Build-Measure-Learn loop helps us to find answers to our assumptions or hypothesis. Although at different stages of product development we will be looking for different answers to core assumptions, one thing will be certain: our most important task is to gather as much actionable knowledge as possible, in the shortest time possible.</p>
                            <p>This is done by developing experiments to validate our hypothesis. There are various ways to test different hypothesis, most often with the help of an MVP or minimum viable product.</p>
                            <p>An MVP is a product or experiment that we can build with minimal effort (or development time in case of a software). Its sole purpose is to test (validate) our assumptions. Most often, features that are otherwise considered essential to the final product are left out because of this.</p>
                            <p>Creating an MVP will be the Build phase of our Build-Measure-Learn feedback loop.</p>
                            <p>It’s not enough to, in fact it is crucial not to, only develop an MVP for internal use. If only our inner circle has access to the MVP, we can easily get the false sense that everything works and our assumptions are correct.</p>
                            <p>We should get the MVP in front of potential customers as soon as possible, gauge their reactions and gather feedback and actionable metrics.</p>
                            <p>This is the Measure phase of the Build-Measure-Learn loop, which followed immediately by the Learn phase.</p>
                            <p>Based on the feedback and metrics gathered, we should again take a look at our base assumptions. How many have been proved to be true? Are we closer to our product vision? If we are, we should define a new set of assumptions, fine-tune our MVP or create new experiments and start the Build-Measure-Learn loop again.</p>
                            ...
                            <figure>
                                <img src="{{ asset('media/blog/dont-try-to-build-the-perfect-product-making-sense-of-mvp-en.png') }}" alt="You need to consider having an MVP because it gives you the opportunity to test your product with actual users in the real market." />
                                <figcaption>Building an MVP in order to validate how we can get from point A to point B</figcaption>
                            </figure>
                            ...
                            <p>Although this takes some effort, this would allow him to test further assumptions: will he have enough customers and how many of them will return to buy again? He would also get feedback from the customers on how he could improve the product, which he could integrate in the final product. If he would’ve created all the content beforehand, Archie would not have this option.</p>
...
<script type="application/ld+json">
{
    ...
    "description": "In today’s article, we will illustrate through a concrete example why it is not worth building a perfect product.",
