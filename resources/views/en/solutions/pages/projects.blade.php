...
@section('title', 'Custom Project Management Software')
@section('description', 'Organise, plan and analyse your projects with our custom developed project management solutions.')
    ...
    <section class="section">
        <div class="solution">
            <div class="container">
                <div class="columns">
                    <div class="column">
                        <h1 class="heading">Bespoke PM Software</h1>
                    </div>
                </div>
                <div class="columns is-mobile">
                    <div class="column is-10-mobile is-offset-1-mobile is-8-tablet is-offset-2-tablet">
                        <p class="solution__intro">Organise, plan and analyse your projects with our custom developed project management solutions.</p>
                    </div>
                </div>
                <div class="columns">
                    <div class="column">
                        <h3 class="heading-3">Schedule and plan activities at a glance</h3>
                    </div>
                </div>
                <div class="columns">
                    <div class="column is-half-tablet">
                        <p>Before we start building you the software, we go through a detailed analysis process so we understand the nature of your business, your workflow and the participants. This allows us to find the optimal way of representing your data, making it easy to get quick access to current status, urgent matters, deadlines and responsibles.</p>
                        <ul class="list has-bullets">
                            <li>quickly create new tasks and assign them to a colleague</li>
                            <li>visualise your data on Kanban boards or on a calendar</li>
                            <li>track progress using GANTT or burndown charts</li>
                            <li>easily update statuses, deadlines and responsibilities</li>
                        </ul>
                    </div>
                    <div class="column is-half-tablet">
    ...
    <section class="section">
        <div class="solution">
            <div class="container">
                <div class="columns">
                    <div class="column">
                        <h3 class="heading-3">Plan-ahead by budgeting your resources</h3>
                    </div>
                </div>
                <div class="columns">
                    <div class="column is-half-tablet">
                        <p>We can help estimate your upcoming projects more accurately by analysing comparable past projects, real timesheets and taking into account resource availability factors, such as employee holidays. For best results, use together with our <a href={{ localizedRoute('solutions.time-tracking') }}>time tracking</a> and <a href={{ localizedRoute('solutions.hr') }}>human resources</a> modules.</p>
                        <ul class="list has-bullets">
                            <li>estimate comparing to past projects and timesheets</li>
                            <li>forecast your needs and resources</li>
                            <li>visualise the current progress and estimated deadlines</li>
                            <li>get alerts when your projects is running behind schedule</li>
                        </ul>
                    </div>
                    <div class="column is-half-tablet">
    ...
    <section class="section">
        <div class="solution__cta">
            <div class="container">
                <div class="columns">
                    <div class="column">
                        <div class="heading-2">Do you want to learn more about our PM solutions?</div>
                ...
                <div class="columns">
                    <div class="column">
                        <ul class="list has-bullets has-two-columns has-margin-b60">
                            <li>visual boards and charts</li>
...
<script type="application/ld+json">
{
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": {
                    ...
                    "name": "Custom Project Management Software"
                }
            }
        ]
    },
    ...
    "description": "Organise, plan and analyse your projects with our custom developed project management solutions.",
    "headline": "Custom Project Management Software",
    "image": {
        "@type": "ImageObject",
        "url": "{{ asset('img/logo.svg') }}",
        "height": "50",
    ...
    "inLanguage": "en_gb",
    "keywords": "Project management, PM software",
