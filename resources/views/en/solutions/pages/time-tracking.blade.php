...
@section('title', 'Time Tracking and Reporting Software')
@section('description', 'With our time tracking solutions, you and your team will be able to log and track time from any device, anywhere. It even works offline.')
    ...
    <section class="section">
        <div class="solution">
            <div class="container">
                <div class="columns">
                    <div class="column">
                        <h1 class="heading">Tailor-made Timesheets</h1>
                    </div>
                </div>
                <div class="columns is-mobile">
                    <div class="column is-10-mobile is-offset-1-mobile is-8-tablet is-offset-2-tablet">
                        <p class="solution__intro">With our time tracking solutions, you and your team will be able to log and track time from any device, anywhere. It even works offline.</p>
                    </div>
                </div>
                <div class="columns">
                    <div class="column">
                        <h3 class="heading-3">Plan and track your time</h3>
                    </div>
                </div>
                <div class="columns">
                    <div class="column is-half-tablet is-two-thirds-desktop">
                        ...
                        <ul class="list has-bullets">
                            ...
                            <li>track time while offline</li>
                            <li>attach time to projects or products</li>
                        </ul>
                    </div>
    ...
    <section class="section is-dark">
        <div class="container">
            <div class="columns is-reversed">
                <div class="column is-half-tablet is-two-thirds-desktop">
                    <h3 class="heading-3">Beautiful and informative timesheets</h3>
                    <p>Once time is logged, we can develop reports of any kind for you. Filter by time interval, client, employee, project or product and make sure your team is on track and your projects are profitable. Integrate with our <a href="{{ localizedRoute('solutions.accounting') }}">accounting module</a>, to directly invoice your clients based on billable hours.</p>
                    <ul class="list has-bullets">
                        <li>generate timesheets</li>
                        <li>filter time entries based on any criteria</li>
                        <li>forecast for future projects</li>
                        <li>invoice timesheets to clients</li>
                    </ul>
                </div>
                <div class="column is-half-tablet is-one-third-desktop">
    ...
    <section class="section">
        <div class="solution__cta">
            <div class="container">
                <div class="columns">
                    <div class="column">
                        <div class="heading-2">Do you want to learn more about our time tracking solutions?</div>
                ...
                <div class="columns">
                    <div class="column">
                        <ul class="list has-bullets has-two-columns has-margin-b60">
                            <li>time tracking</li>
                            <li>daily plans</li>
                            <li>synchronising offline data</li>
                            <li>timesheet generation</li>
                            <li>single-click invoice generation</li>
                        </ul>
                    </div>
                </div>
                <div class="columns">
...
<script type="application/ld+json">
{
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": {
                    ...
                    "name": "Time Tracking and Reporting Software"
                }
            }
        ]
    },
    ...
    "description": "With our time tracking solutions, you and your team will be able to log and track time from any device, anywhere. It even works offline.",
    "headline": "Time Tracking and Reporting Software",
    "image": {
        "@type": "ImageObject",
        "url": "{{ asset('img/logo.svg') }}",
        "height": "50",
    ...
    "inLanguage": "en_gb",
    "keywords": "Time tracking, Timesheet software",
