...
@section('content')
            ...
            <div class="container">
                ...
                <div class="columns is-reversed">
                    <div class="column is-centered-vertical">
                        ...
                        <p>
                            After several preliminary meetings with the providers, we successfully <strong>integrated all the 3rd party systems</strong> through APIs, allowing for the automatic booking of toll and tickets by simply selecting the route.
                        </p>
                    </div>
                    <div class="column">
                        <img src="{{ asset('img/projects/harborsz-overview-1.png') }}" alt="Harborsz - Booking tolls and ferry tickets was a manual process" />
                    </div>
                </div>
                <div class="columns">
                    <div class="column is-centered-vertical">
                        ...
                        <em class="project__text-emphasis">Solution</em>
                        <p>
                            Collecting feedback from the customers, the demand for an <strong>automatable booking process</strong> quickly became apparent. By further interviewing them, we gathered a lot of valuable input on what their use cases are, and developed an API to our system that would handle all their business needs.
                        </p>
                    </div>
                    <div class="column">
                        <img src="{{ asset('img/projects/harborsz-overview-2.png') }}" alt="Harborsz - Customers had to directly contact Harborsz for booking" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <a class="project__gallery" data-toggle="modal" data-target="#gallery-modal">
            <img src="{{ asset('img/projects/harborsz-gallery.jpg') }}" alt="Open gallery" />
