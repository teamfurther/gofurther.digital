...
@section('title', 'MVP fejlesztés start-upoknak')
@section('description', 'Van egy jó ötleted és szeretnéd gyorsan és profin piacra vinni a termékedet? A Further segít az MVP elkészítésében és a növekedésben.')
                ...
                <div class="column is-offset-1-widescreen">
                    <div class="columns has-margin-b90 is-mobile">
                        <div class="column is-3-mobile is-2-tablet is-offset-1-tablet is-offset-0-widescreen">
                            <img src="{{ asset('img/mvp-development-discover-icon.png') }}" alt="MVP fejlesztés - Megismerés" />
                        </div>
                    ...
                    <div class="columns has-margin-b90 is-mobile">
                        <div class="column is-3-mobile is-2-tablet is-offset-1-tablet is-offset-0-widescreen">
                            <img src="{{ asset('img/mvp-development-ideate-icon.png') }}" alt="MVP fejlesztés - Ötletelés" />
                        </div>
                        <div class="column is-8-tablet">
                    ...
                    <div class="columns has-margin-b90 is-mobile">
                        <div class="column is-3-mobile is-2-tablet is-offset-1-tablet is-offset-0-widescreen">
                            <img src="{{ asset('img/mvp-development-prototype-and-test-icon.png') }}" alt="MVP fejlesztés - Validáció" />
                        </div>
                        <div class="column is-8-tablet">
                    ...
                    <div class="columns has-margin-b90 is-mobile">
                        <div class="column is-3-mobile is-2-tablet is-offset-1-tablet is-offset-0-widescreen">
                            <img src="{{ asset('img/mvp-development-implement-icon.png') }}" alt="MVP fejlesztés - Megvalósítás" />
                        </div>
                        <div class="column is-8-tablet">
                    ...
                    <div class="columns has-margin-b90 is-mobile">
                        <div class="column is-3-mobile is-2-tablet is-offset-1-tablet is-offset-0-widescreen">
                            <img src="{{ asset('img/mvp-development-evolve-icon.png') }}" alt="MVP fejlesztés - Elemzés és továbbfejlesztés" />
                        </div>
                        <div class="column is-8-tablet">
    ...
    <script type="application/ld+json">
{
    ...
    "description": "Van egy jó ötleted és szeretnéd gyorsan és profin piacra vinni a termékedet? A Further segít az MVP elkészítésében és a növekedésben.",
