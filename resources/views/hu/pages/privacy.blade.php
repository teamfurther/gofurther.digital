        ...
        <div class="container">
            <div class="columns">
                <div class="column is-8-desktop is-offset-2-desktop">
                    ...
                    <p>A C4WEB STUDIO SRL (Further Digital Solutions) szigorúan tiszteletben tartja a személyes adatok bizalmasságát. Kérjük, vegye fel velünk a kapcsolatot, ha bármilyen kérdése vagy észrevétele van az adatvédelmi szabályzattal kapcsolatban.</p>
                    <p class="has-margin-b60">A jelen adatvédelmi szabályzat meghatározza, hogy a Further Digital Solutions hogyan dolgozza fel a személyes adatokat, és kizárólag a Further Digital Solutions által a Further honlapon gyűjtött személyes adatokra vonatkozik. A jelen adatvédelmi szabályzat nem vonatkozik a Further által bármilyen más eszközzel vagy más honlapon keresztül gyűjtött személyes adatokra. A Further Digital Solutions által gyűjtött összes személyes adatot a hatályos adatvédelmi jogszabályoknak megfelelően használják.</p>
                    ...
                    <p class="has-margin-b60">A Further Digital Solutions társaságnál személyes adatai csak a menedzsment csapat számára hozzáférhetők. Személyes adatai nem lesznek elérhetők harmadik felek vagy adatfeldolgozók számára.</p>
                    ...
                    <p>A következő jogai vannak a személyes adataival kapcsolatban:</p>
                    <ul class="list has-bullets">
                        <li>megnézni, milyen esetleges adataink vannak Önről;</li>
                        <li>módosítani/ frissíteni az Ön adatait;</li>
                        <li>töröltetni az Önnel kapcsolatos összes adatot;</li>
                        <li>adatátviteli kérelmet tenni;</li>
                        <li>kifejezni bármilyen aggodalmat az adatai használatával kapcsolatban.</li>
                    </ul>
                    <p>Ha bármikor kérdése van a fentiekkel kapcsolatban, akkor egyszerűen küldje el kérést e-mailben a következő címre: <a href="mailto:hello@gofurther.digital">hello@gofurther.digital</a>.</p>
                    ...
                    <p>Ha közvetlenül kapcsolatba szeretne lépni velünk az adatvédelmi szabályzattal kapcsolatban, kérjük, írjon nekünk a következő címre: <a href="mailto:hello@gofurther.digital">hello@gofurther.digital</a>.</p>
                </div>
            </div>
        </div>
    </section>
