        ...
        <div class="container">
            <div class="columns is-multiline">
                ...
                <div class="column is-12-tablet is-4-desktop is-offset-1-desktop">
                    {!! $bodyText ?? '<p>Havonta  eredeti tartalmakat és híreket osztunk meg digitális transzformációról, új technológiákról, szoftverfejlesztésről és start-upokról. Iratkozz fel, hogy ne maradj le a friss tartalmakról.</p><p class="has-margin-b30">Havonta egyszer küldünk ki hírlevelet.</p>' !!}
                </div>
            </div>
        </div>
</div>
