...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-the-lean-product-process-1-hu.png') }}" srcset="{{ asset('media/blog/featured-the-lean-product-process-1-769w-hu.png') }} 769w, {{ asset('media/blog/featured-the-lean-product-process-1-1000w-hu.png') }} 1000w" sizes="100vw" alt="A lean termékfejlesztési folyamat: 1. Értsük meg a felhasználóinkat" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <figure>
                                <img src="{{ asset('media/blog/validation-in-product-development-cheat-sheet-1-hu.png') }}" alt="Validáció a termékfejlesztésben-Segédlet-1" />                            </figure>
                            ...
                            <p>Sok start-up már ezen a ponton elköveti a végzetes hibát és nem tölt el (elegendő) időt a probléma feltevések megértésével. Ezek a csapatok egy bentről-kifelé megközelítést alkalmaznak, amelyben a vízió egy belső igényből fakad és egy vagy több csapattag, esetleg egy pár ismerős véleménye alapján úgy döntenek, hogy érdemes belekezdeni az építkezésbe.</p>
                            ...
                            <p>Ha mindegyik feltevésre megerősítő választ kaptunk, akkor továbbléphetünk a termékfejlesztés következő szakaszára. Ez azonban ritkán szokott bekövetkezni. Ezekben az ellenkező esetekben következik be az úgynevezett pivot, vagyis a fókuszváltás. Egy pivot során a tanultak alapján módosítunk a feltevéseinken és újrakezdjük ezeknek a validációját.</p>
