...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-11-ways-to-build-an-mvp-1-hu.png') }}" srcset="{{ asset('media/blog/featured-11-ways-to-build-an-mvp-1-768w-hu.png') }} 768w, {{ asset('media/blog/featured-11-ways-to-build-an-mvp-1-1000w-hu.png') }} 1000w" sizes="100vw" alt="11 mód, hogy MVP-t építsünk" />
    </div>
        ...
        <div class="post is-single h-entry">
            <div class="post__header">
                <div class="container">
                    <div class="columns">
                        <div class="column">
                            <h1 class="post__title p-name">11 mód, hogy MVP-t építsünk</h1>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">Ez a módszer kiváló, hogy egy virális növekedési motort szeretnénk alkalmazni, hiszen a megosztásokból hamar kirajzolódik mennyire virális a termékünk. Ráadásul egy ki ingyen marketinget is kapunk.</p>
                            ...
                            <p>Ugyanakkor ez egy tökéletes pont arra, hogy ketté bontsam a cikket (Google szeretni fog érte). Egyszóval tartsatok velem, a folytatásban megnézzük azokat a prototípusokat, amelyek már nem csak bemutatják a terméket, hanem érzékeltetik is annak működését a felhasználókkal.</p>
                        </div>
    ...
    <script type="application/ld+json">
{
    ...
    "image": {
        ...
        "height": 630,
        "width": 1200,
        "url": "{{ asset('media/blog/cover-11-ways-to-build-an-mvp-1-hu.png') }}"
    },
    "inLanguage": "hu_hu",
