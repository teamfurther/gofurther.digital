                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Ezeket nevezzük érték feltevésnek, vagy érték hipotézisnek. Ahogy az a nevéből is következik, az érték feltevés azt állapítja meg, hogy a megoldásunk értéket fog teremteni a felhasználóink számára.</p>
                            <figure>
                            ...
                            <p>Ha több perszónánk van, akkor több value proposition canvas-ünk is lesz, hiszen minden egyes felhasználó csoportnak számára értelemszerűen más-más lesz az értékajánlatunk. Minden egyes tevékenységet, fájdalompontot és hasznot írjunk fel egy post-itra és ragasszuk be a megfelelő helyre. Ha digitálisan szeretnénk value proposition canvas-t kitölteni, akkor a <a href="https://miro.com/" target="_blank">Miro</a> szoftvert ajánlom.</p>
                            <p class="has-margin-b30">Ha megvagyunk a körrel, akkor következhet a négyzet, amit értéktérképnek neveznek Osterwalderék a könyvben. A változatosság kedvéért a négyzet is háromba van osztva:</p>
                            <ul class="list has-bullets has-margin-b30">
                            ...
                            <p class="has-margin-b60">A value proposition canvas-t kitölthetjük magunkban, a csapatunkkal közösen, de a legizgalmasabb kísérlet talán az, amikor ezt is potenciális felhasználókkal közösen állítjuk össze.</p>
                            {{--<p><a href="" target="_blank">Töltsd le az ingyenes startup eszköz sablonjainkat, amelyben kitölthető value proposition canvas sablont is találsz.</a></p>--}}
                            ...
                            {{--<p><a href="" target="_blank">Töltsd le az ingyenes startup eszköz sablonjainkat, amelyben kitölthető user-centered business canvas sablont is találsz.</a></p>--}}
                            ...
                            <p>Ez a módszer értelemszerűen nem minden termék esetében működik. A mi esetünkben is nehezen megvalósítható, hacsak nem szeretnénk egy elektromos rollert mögött futva kiabálni ha veszélyt észlelünk. Ez nemcsak nehezen megvalósítható, hanem meglehetősen messze is áll az elvárt felhasználói élménytől.</p>
    ...
    <script type="application/ld+json">
{
    ...
    "image": {
        ...
        "height": 630,
        "width": 1200,
        "url": "{{ route('generate-cover', ['title' => 'A lean termékfejlesztési folyamat: 2. Fogalmazzuk meg az értékajánlatunkat']) }}"
    },
    "inLanguage": "hu_hu",
