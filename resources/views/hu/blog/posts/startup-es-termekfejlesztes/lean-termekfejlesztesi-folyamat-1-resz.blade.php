                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">A termékfejlesztés első szakaszában, a probléma validációs fázisban – azon belül is az Építs-Mérj-Tanulj ciklus Tanulj részében – a fenti feltételezések közül az első háromra koncentrálunk. Ezeket nevezzük probléma feltevésnek vagy probléma hipotézisnek.</p>
                            <h2 class="heading-2 has-margin-b30">Kintről-befelé megközelítés</h2>
                            ...
                            <p class="has-margin-b60">Éppen ezért nagyon fontos, hogy mielőtt elkezdünk emberekkel beszélgetni, pontosan határozzuk meg, hogy kinek a véleményére vagyunk kíváncsiak. Ki az, akinek a problémáját meg szeretnénk határozni? Erre a legjobb módszer az úgynevezett perszónák felépítése.</p>
                            <h3 class="heading-3 has-margin-b30">Perszónák</h3>
                            ...
                            <p class="has-margin-b60">A vízió és a perszónák meghatározásával meg is tettük a legfontosabb lépéseket a tanulási ciklus Építs szakaszában.</p>
{{--                            <p><i>Töltsd le az ingyenes startup eszköz sablonjainkat, amelyben kitölthető perszóna sablon is találsz.</i></p>--}}
                            <h2 class="heading-2 has-margin-b30">Értsük meg a felhasználóinkat</h2>
                            ...
                            <p class="has-margin-b60">Mint azt már korábban is említettem, a probléma validációs fázisban, a Mérj szakasz leghasznosabb és egyben leghatékonyabb eszköze az <a href="{{ localizedRoute('blog.show', ['slug' => 'egy-sikeres-felhasznaloi-interju-titkai']) }}" target="_blank">interjúztatás</a> lesz.</p>
                            <h3 class="heading-3 has-margin-b30">Felhasználói interjúk</h3>
                            ...
                            <p class="has-margin-b60">Ebből már tanulhatunk. Lehet, hogy nem is a gördeszkás lány lesz a vásárlónk? Hanem a szülei? A lány csak egy felhasználó? Ez egy olyan szempont, amire későbbi interjúk során is érdemes lesz odafigyelni és rákérdezni. Ha kialakul egy minta, akkor érdemes lesz egy külön vásárlói perszónát erre felállítanunk – az aggódó szülő perszónát –, akiket ismét, külön is interjúztatunk majd. Ez már egyfajta <a href="{{ localizedRoute('blog.show', ['slug' => 'pivot-vagy-nem-pivot']) }}" target="_blank">pivot</a> (fókuszváltás), de erről majd később.</p>
                            <h3 class="heading-3 has-margin-b30">Terepmegfigyelés</h3>
                            ...
                            <p class="has-margin-b60">Mérlegeljünk, mennyi hasznos információt kapunk a terepmegfigyelések során. Megéri-e a nekünk a befektetett időt? Vagy inkább használjuk fel azt az időt arra, hogy interjúztatunk. Egy dolog biztos, hogy a terepmegfigyelés nem helyettesítheti az interjúkat. Viszont könnyen felkeszíthet minket egy interjúra, hogy jobban tudjunk kérdezni.</p>
                            <h3 class="heading-3 has-margin-b30">Élménytérkép</h3>
                            <p>Az <a href="{{ localizedRoute('blog.show', ['slug' => 'mire-jo-a-customer-journey-map']) }}">élménytérkép</a> szintén egy jó eszköz lehet ebben a fázisban, hogy jobban megismerjük a felhasználóink (perszónák) viselkedését és kihívásait. Az élménytérkép egy kollaboratív eszköz, amely segít illusztrálni egy perszóna útját (élményét) egy konkrét narratíván keresztül.</p>
