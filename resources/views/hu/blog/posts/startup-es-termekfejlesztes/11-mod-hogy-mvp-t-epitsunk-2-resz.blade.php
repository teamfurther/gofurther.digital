...
@section('preview_image', asset('media/blog/cover-11-ways-to-build-an-mvp-2-hu.png'))

@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-11-ways-to-build-an-mvp-2-hu.png') }}" srcset="{{ asset('media/blog/featured-11-ways-to-build-an-mvp-2-768w-hu.png') }} 768w, {{ asset('media/blog/featured-11-ways-to-build-an-mvp-2-1000w-hu.png') }} 1000w" sizes="100vw" alt="11 mód, hogy MVP-t építsünk" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Amint láttuk, az említett prototípusok tökéletesen működnek az értékajánlatunk, a felhasználói élmény és a piaci igény felmérésére. De csak akkor, ha előtte a problémát magát már <a href="{{ localizedRoute('blog.show', ['slug' => 'lean-termekfejlesztesi-folyamat-1-resz']) }}" target="_blank">validáltuk</a> és megfelelő mérési pontokat állítunk fel. Tartsatok velem, a következőkben ezekbe a mérési technikákba, illetve egyéb termékfejlesztési és startup témákba is elmélyülünk.</p>
                        </div>
