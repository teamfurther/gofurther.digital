                    ...
                    <div class="columns">
                        <div class="column">
                            ...
                            <div class="post__meta">
                                <time class="dt-published" datetime="2022-05-18 10:00:00">May 18th, 2022</time> &middot; 6 perces olvasás
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <figure>
                                <img src="{{ asset('media/blog/vpc-structure.jpg') }}" alt="A Value Proposition Canvas felépítése" />
                            </figure>
                            ...
                            <figure>
                                <img src="{{ asset('media/blog/value-map.jpg') }}" alt="Értéktérkép (Value Map)" />
                            </figure>
                            ...
                            <ul class="list has-bullets has-margin-b30">
                                <li>1. Válassz egy célcsoportot.</li>
                                <li>2. Határozd meg, milyen feladataik vannak az ügyfeleknek.</li>
                                <li>3. Határozd meg a fájdalom pontokat, amelyekkel szembesülnek a feladatok elvégzése közben.</li>
                                <li>4. Határozd meg, milyen előnyöket remélnek a felsorolt feladatok elvégzésétől.</li>
                                <li>5. Válaszd ki a 3-5 legfontosabb fájdalompontot és nyereséget.</li>
                                <li>6. Sorold fel a termék vagy szolgáltatás összes előnyét.</li>
                                <li>7. Azonosítsd a lehetséges fájdalomcsillapítókat.</li>
                                <li>8. Azonosítsd a potenciális nyereséget teremtőket.</li>
                                <li>9. Válaszd ki azokat a nyereség teremtőket és fájdalomcsillapítókat, amelyek a legjelentősebb változást hozzák ügyfeleid számára.</li>
                                <li>10. Találd meg az összefüggést a nyereséget teremtő és a nyereség, a fájdalomcsillapítók és a fájdalom pontok között. Ez lesz az Értékajánlat.</li>
                                <li>11. Fogalmazd meg az értékajánlatot (értékajánlatokat) egyetlen (összetett) mondatként, amely tisztázza a kínált értéket a felhasználók számára.</li>
                                <li>12. Teszteld értékajánlatot (ajánlatokat) ügyfeleiddel.</li>
                            </ul>
                        </div>
