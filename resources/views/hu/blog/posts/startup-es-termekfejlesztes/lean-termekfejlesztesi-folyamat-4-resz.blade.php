                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Milyen mérőszámok segítségével tudjuk ezeket validálni? A mérőszámoknak fogok <a href="{{ localizedRoute('blog.show', ['slug' => 'hogyan-merjuk-a-termekunk-sikeresseget']) }}" target="_blank">egy külön cikket</a> is szentelni később, de lássuk most a legfontosabbakat. Mielőtt beleugrunk azonban, kiemelném az egyik legnagyobb hibát amit el szoktak követni a startupok: nem tudnak ellenállni a metrikák varázsának.</p>
                            ...
                            <p class="has-margin-b60">A növekedés érdekében minden startup eleinte a CAC csökkentésére kell fókuszáljon. Ha a CAC idővel nem csökken, akkor az egy intő jel, hogy az üzleti modellünk nem fenntartható hosszú távon. Egy <a href="{{ localizedRoute('blog.show', ['slug' => 'epitsunk-novekedesi-motort']) }}" target="_blank">fizetett növekedési motor</a> esetében elfogadható lehet, ha a CAC nem csökken idővel, azonban abban az esetben is kívánatos a csökkenő tendencia.</p>
                            ...
                            <p>A lemorzsolódási arány, angolul churn rate, azt mutatja, hogy az egyszer megszerzett vásárlókat, milyen arányban sikerül hosszú távon megtartanunk. Hasonló megfontolásból fontos mérőszám mint a konverziós arány. Minél nagyobb arányban tudjuk megtartani a felhasználóinkat, annál kevesebbet kell új felhasználók megszerzésére költenünk a növekedéshez. Az a metrika kiemelten fontos, ha <a href="{{ localizedRoute('blog.show', ['slug' => 'epitsunk-novekedesi-motort']) }}" target="_blank">ragadós növekedési motort</a> alkalmazunk.</p>
