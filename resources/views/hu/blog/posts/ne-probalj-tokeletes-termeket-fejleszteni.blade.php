                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>A prototípus létrehozása lesz az Építs szakaszunk az Építs-Mérj-Tanulj ciklusban.</p>
                            <p>Nem elég, sőt óriási hiba, ha egy prototípust csak belső használatra, azaz saját magunk megnyugtatására fejlesztünk. Nem elég, ha csak mi magunk, szűk körben úgy látjuk, hogy igen, ez működőképes és alátámasztja a feltételezéseinket.</p>
                            <p>A prototípus célja, hogy minél hamarabb be tudjuk mutatni a potenciális vásárlóinknak, figyeljük meg a reakciójukat, kapjunk visszacsatolást és mindezt támasszuk alá releváns mérőszámokkal.</p>
                            <p>Ez lesz a Mérj szakaszunk az Építs-Mérj-Tanulj ciklusban, amit rögtön követ a Tanulj szakasz.</p>
                            <p>A visszacsatolás birtokában nézzük meg, melyik feltételezéseink bizonyultak igaznak. Döntsük el, hogy a termékfejlesztésnek ebben a fázisában közelebb állunk-e a kitűzött céljainkhoz. Ha igen, <a href="{{ localizedRoute('blog.show', ['slug' => 'validacio-a-termekfejlesztesben']) }}">állítsunk fel újabb feltételezéseket</a>, finomhangoljuk a meglévő prototípust vagy dolgozzunk ki újabb kísérleteket és kezdjük előlről az Építs-Mérj-Tanulj ciklust.</p>
