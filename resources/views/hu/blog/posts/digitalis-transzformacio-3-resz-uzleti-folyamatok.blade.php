...
@section('description', 'Sorozatunk harmadik részében megnézzük hogyan segítheti a BPM és az agilis metódusok a digitális transzformációt.')
@section('preview_image', asset('media/blog/cover-digital-transformation-3-hu.jpg'))

@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-digital-transformation-3-hu.jpg') }}" srcset="{{ asset('media/blog/featured-digital-transformation-3-769w-hu.jpg') }} 769w" sizes="100vw" alt="Digitális transzformáció sorozat 3. rész - Üzleti folyamatok" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <h2 class="heading-3 has-margin-b30">Legyen gyors, legyen agilis</h2>
                            <p>Az agilis egy másik kifejezés, amely gyakran kapcsolódik a digitális transzformációhoz. Az agilis fogalom az ú.n. Agile Manifestoban leírt értékek és elvek halmazát takarja. Ugyanakkor az agilis fogalom szorosan kapcsolódik az informatikai iparághoz, ahol széles körben használják. Előnyei egyértelműek és bizonyítottak, ezért nincs ok arra, hogy más üzleti területeken ne alkalmazzák.</p>
                            ...
                            <div class="has-text-centered">
                                <a class="btn is-primary" href="{{ localizedRoute('blog.view', ['slug' => 'digitalis-transzformacio-2-vallalati-kultura']) }}">&laquo; 2. rész - Vállalati kultúra</a>
                                <a class="btn is-primary" href="{{ localizedRoute('blog.view', ['slug' => 'digitalis-transzformacio-4-resz-technologia']) }}">4. rész - Technológia &raquo; </a>
                            </div>
                        </div>
...
<script type="application/ld+json">
{
    ...
    "description": "Sorozatunk harmadik részében megnézzük hogyan segítheti a BPM és az agilis metódusok a digitális transzformációt.",
    "headline": "Digitális transzformáció sorozat 3. rész - Üzleti folyamatok",
    "image": {
        "@type": "ImageObject",
        "height": 630,
        "width": 1200,
        "url": "{{ asset('media/blog/cover-digital-transformation-3-hu.jpg') }}"
    },
    "inLanguage": "hu_HU",
