...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-the-lean-product-process-3-hu.png') }}" srcset="{{ asset('media/blog/featured-the-lean-product-process-3-768w-hu.png') }} 768w, {{ asset('media/blog/featured-the-lean-product-process-3-1000w-hu.png') }} 1000w" sizes="100vw" alt="A lean termékfejlesztési folyamat: 3. Építsünk prototípust" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60">Ezért egy olyan sallangmentes termék építése a cél, amiben csak az a minimális funkció található meg, ami szükséges ahhoz, hogy a feltevéseinket validáljuk. Ezt nevezik a startup világban MVP-nek.</p>
                            <h3 class="heading-3 has-margin-b30">MVP</h3>
                            <p>Az MVP, vagyis a minimum-viable product kifejezést 2001-ban Frank Robinson használta először, majd Steve Blank és Eric Ries népszerűsítette, mára pedig a startup zsargon talán legismertebb kifejezésévé vált, amit a startup buborékon kívül állók is sokan ismernek. De amennyire népszerű az MVP kifejezés, annyira megosztó is.</p>
                            <p>Akik figyelemmel követték <a href="{{ localizedRoute('blog.tags.show', ['slug' => 'startup']) }}" target="_blank">a termékfejlesztésről szóló cikkeimet</a> lehet kiszúrták már, hogy kerülöm az MVP kifejezést és inkább a kísérlet vagy a prototípus szavakkal helyettesítem. Ennek az oka az, hogy a nevének összetevőit egyenként és együttesen is könnyen félre lehet értelmezni.</p>
                            ...
                            <p class="has-margin-b60"><a href="{{ localizedRoute('blog.show', ['slug' => '11-mod-hogy-mvp-t-epitsunk-1-resz']) }}" target="_blank">Sokféle prototípust tudunk megkülönböztetni</a>, lássunk ezek közül most egy párat amik a legelterjedtebbek a megoldás-termék illeszkedés szakaszban.</p>
                            ...
                            <p>Ha nagyon pontosan akarjuk érzékeltetni a végső felhasználói élményt, akkor tovább fokozhatjuk az interaktivitást. Animációkat vihetünk bele a mockupba, vagy megmutathatjuk hogy tud egy-egy mezővel interakcionálni a felhasználó (megváltozik a színe kattintáskor, piros lesz ha nem elfogadható értéket adunk meg, stb.).</p>
