...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-how-to-measure-the-success-of-your-startup.png') }}" srcset="{{ asset('media/blog/featured-how-to-measure-the-success-of-your-startup-768w.png') }} 768w, {{ asset('media/blog/featured-how-to-measure-the-success-of-your-startup-1000w.png') }} 1000w" sizes="100vw" alt="Hogyan mérjük a termékünk sikerességet?" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>Dave McClure, a 500 Startups befektetési alap és startup inkubátor alapítója egy 2007-es elődásában mutatta be a "Startup Metrics for Pirates" (Startup metrikák kalózoknak) keretrendszerélt. Dave 5 makró-metrikát különböztetett meg, amire egy startup termék esetében oda kell figyelni:</p>
