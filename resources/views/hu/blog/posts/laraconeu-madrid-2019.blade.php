...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-laraconeu-madrid-2019.png') }}" srcset="{{ asset('media/blog/featured-laraconeu-madrid-2019-769w.png') }} 769w" sizes="100vw" alt="Élménybeszámoló a LaraconEU Madrid 2019-ről" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            <p>Május 23-a különleges nap volt számunkra, mivel részt vettünk az első Laracon találkozónkon Madridban. 2014 óta használjuk a Laravelt (4.2-es verzió), az egyik <a href="{{ localizedRoute('tech-stack') }}">legkedveltebb technológiánk</a> és mi is aktívan részt veszünk a helyi közösségben, ezért a Laracon mindig is ott volt a konferenciák kívánságlistánkon, de mostanáig nem sikerült eljutnunk.</p>
