...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-remote-corporate-culture-3-hu.png') }}" srcset="{{ asset('media/blog/featured-remote-corporate-culture-3-769w-hu.png') }} 769w" sizes="100vw" alt="Hogyan építsünk remote vállalati kultúrát" />
    </div>
