...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-homebrewing-crowdfunding-and-30000-dollars-in-2-minutes-the-brewie-story.png') }}" srcset="{{ asset('media/blog/featured-homebrewing-crowdfunding-and-30000-dollars-in-2-minutes-the-brewie-story-768w.png') }} 768w, {{ asset('media/blog/featured-homebrewing-crowdfunding-and-30000-dollars-in-2-minutes-the-brewie-story-1000w.png') }} 1000w" sizes="100vw" alt="EXTRA: Otthoni sörfőzés, crowdfunding és két perc alatt $30.000 — A Brewie story" />
    </div>
