...
@section('description', 'Üdvözöljük a digitális átalakulással kapcsolatos sorozatunk első részében. Merüljünk is el a témában, és kezdjük a digitális átalakulás valós jelentésével.')
@section('preview_image', asset('media/blog/cover-digital-transformation-1-hu.jpg'))

@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-digital-transformation-1-hu.jpg') }}" srcset="{{ asset('media/blog/featured-digital-transformation-1-769w-hu.jpg') }} 769w" sizes="100vw" alt="Digitális transzformáció sorozat 1. rész - Bevezető" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            <p>Üdvözöljük a digitális transzformációval kapcsolatos sorozatunk első részében. Ha egy bizonyos cikket keres a sorozatból, akkor itt megtalálja a linkeket:</p>
