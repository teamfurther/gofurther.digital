...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-remote-corporate-culture-4-hu.png') }}" srcset="{{ asset('media/blog/featured-remote-corporate-culture-4-768w-hu.png') }} 768w, {{ asset('media/blog/featured-remote-corporate-culture-4-1000w-hu.png') }} 1000w" sizes="100vw" alt="Ötletek önmagunk motiválására" />
    </div>
