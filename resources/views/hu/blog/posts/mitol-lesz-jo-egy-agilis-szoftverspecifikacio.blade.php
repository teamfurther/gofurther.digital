                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p class="has-margin-b60"><em>Képzelje el a házépítés folyamatát. Először írja le az elképzelését, hány szobát és milyen jellemzőket szeretne. Ezek a célok. A telek sajátosságai és az építési törvények az Ön korlátai.</em></p>
                            ...
                            <p class="has-margin-b60"><em>Gondoljon erre úgy, mint a tényleges ház terveire: alaprajzok, építési tervek, statikai tervek, metszetek, anyagok, villamos- és gépészeti tervek és így tovább.</em></p>
                            ...
                            <p class="has-margin-b60"><em>Ezek lehetnek az Ön házának minőségi előírásai és az ellenőrző dokumentumok, amelyek biztosítják a ház megfelelő működését jelenleg és a belátható jövőben.</em></p>
                            ...
                            <p class="has-margin-b60">Az agilis módszer rugalmassága lehetővé teszi a projekt hatáskörének a megváltoztatását a fejlesztés során, a hagyományos módszerekkel ellentétben, ahol mindez csak a fejlesztés végén történhet, gyakran több hónapos munka lenullázásával vagy megismétlésével. Ez természetesen magas költségekkel, a határidők elmulasztásával, és nem utolsó sorban a motiváció csökkenésével jár minden érintett számára.</p>
                            <h2 class="heading-3 has-margin-b30">Hogy csináljuk mi mindezt?</h2>
                            <p>Lássuk, mi hogyan dolgozunk a Further-nél. Kétféle ügyfelünk van. Azok, akiknek már megvannak a szoftverkövetelményei, és azok, akiknek csak egy rövid projektvázlata van, vagy csak egy ötletük. Általában egyik sincs a végfelhasználó szemszögéből leírva.</p>
                            ...
                            <p>Egy extra dolog, amit néha a projekt elindítása előtt elvégzünk, az, hogy egy pár drótvázat létrehozunk az összetettebb interfészekhez. Ez ellentmondásos az agilis gyakorlatokkal, mert a fejlesztés előtt részletes specifikációt hozunk létre, de úgy tapasztaltuk, hogy segít csapatunknak a jobb becslések elkészítésében.</p>
                            <p>Egy érdekes dolog, amit bevezettünk, az, hogy nálunk gyakran átfedés van a tervezési sprintek és a fejlesztési sprintek között. Egy tervezési sprinttel kezdünk, amelyben elkészítjük a kiválasztott felhasználói történetekre vonatkozó tényleges specifikációkat (tervdokumentumok, tesztesetek, kockázati mátrixok és drótvázak vagy prototípusok).</p>
