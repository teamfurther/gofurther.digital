...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-to-pivot-or-not-to-pivot.png') }}" srcset="{{ asset('media/blog/featured-to-pivot-or-not-to-pivot-768w.png') }} 768w, {{ asset('media/blog/featured-to-pivot-or-not-to-pivot-1000w.png') }} 1000w" sizes="100vw" alt="Pivot vagy nem pivot: az itt a kérdés" />
    </div>
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <p>A zoom-in pivot esetében az eddigi kísérleteink valószínüleg azt mutatták, hogy az értékajánlatunk a termék egyetlen funkciójában rejlik. Tehát, egy olyan funkcióra fogunk 100%-ban koncentrálni, ami eddig csupán egy része volt a terméknek.</p>
