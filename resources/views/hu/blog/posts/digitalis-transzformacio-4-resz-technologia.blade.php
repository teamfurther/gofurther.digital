...
@section('description', 'Sorozatunk záró cikkében, a digitális transzformáció puzzle utolsó darabjával foglalkozunk és megnézzük hogyan használhatja ki a technológiában rejlő lehetőségeket, hogy előrelendítse vállalkozását.')
                ...
                <div class="container">
                    <div class="columns is-reversed">
                        <div class="column is-10-tablet is-8-desktop e-content">
                            ...
                            <h2 class="heading-3 has-margin-b30">Már automatizálta munkafolyamatait?</h2>
                            <p>Az automatizálás az első olyan lépés amit meg kell tennie. Az országa átlagbérétől függően egy 250.000 dolláros ipari robot, valamint annak karbantartási és működési költségei pár év alatt kiegyenlítik egy alkalmazott költségeit (1 év alatt Németországban, 6 év alatt Mexikóban)<sup><a href="https://ark-invest.com/research/robots-will-save-manufacturing-billions" target="_blank">1</a></sup>. És mindez anélkül, hogy figyelembe vennénk az alkamazottak kiképzését, az alkalmazási költségeket és a munkahelyi baleseteket. Ez nem igényel több gondolkodást.</p>
                            ...
                            <h2 class="heading-3 has-margin-b30">Mérjen mindent</h2>
                            ...
                            <p>Az első lépés egy adatstratégia létrehozása: mire használják fel az adatokat? Hogyan hoz mindez értéket? A kérdések megválaszolása után megtervezheti, hogyan generálja, gyűjti össze és elemezi az adatokat. Előfordulhat, hogy el kell búcsúznia idejétmúlt rendszerektől (igen, itt az Excel táblázatokra gondolok), és egy belső elemzői csoportot kell létrehoznia, vagy külső szakembereknek kell átadja az elemzési munkát.</p>
                            <p class="has-margin-b60">Néhány olyan terület, ahol az adatok segíthetnek: kielemezheti a kínálat- és a keresletbeli különbségeket, a kiaknázatlan források jobb felhasználását, az emberi hibák megértését és csökkentését, a viselkedési adatok felhasználását a marketing törekvéseiben vagy a munkaerő megszerzését.</p>
                            ...
                            <h2 class="heading-3 has-margin-b30">Figyeljen az IoT és az Ipar 4.0 kínálta lehetőségeire</h2>
                            ...
                            <p class="has-margin-b60">Legyen résen, hogy az IoT-t hol használhatja fel a termelési folyamatok felügyeletében, az energiagazdálkodásban, a hulladékkezelésben, az ügyfél- és termékadatok összesítésében és a berendezések diagnosztizálásában.</p>
                            <p class="has-margin-b60"><em>Ha élvezte digitális transzformációról szóló sorozatunkat, <a href="{{ url('#contact') }}">vegye fel velünk a kapcsolatot</a>. Mindig szívesen beszélgetünk erről a témáról.</em></p>
...
<script type="application/ld+json">
{
    ...
    "description": "Sorozatunk záró cikkében, a digitális transzformáció puzzle utolsó darabjával foglalkozunk és megnézzük hogyan használhatja ki a technológiában rejlő lehetőségeket, hogy előrelendítse vállalkozását.",
