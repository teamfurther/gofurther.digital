...
@section('content')
    <div class="post__featured-image">
        <img src="{{ asset('media/blog/featured-protect-your-software.png') }}" srcset="{{ asset('media/blog/featured-protect-your-software-768w.png') }} 768w, {{ asset('media/blog/featured-protect-your-software-1000w.png') }} 1000w" sizes="100vw" alt="Védd meg a szoftvered!" />
    </div>
