<div class="post">
    <a class="post__image" href="{{ localizedRoute('blog.show', ['slug' => 'technikai-adossag-hogyan-legyenek-idotallo-it-rendszereink']) }}">
        <img src="{{ asset('media/blog/thumb-technical-debt-how-to-build-future-proof-it-systems.png') }}" alt="Technikai adósság avagy hogyan legyenek időtálló IT rendszereink?" />
    </a>
    <div class="post__content">
        ...
        <h3 class="post__title">
            <a href="{{ localizedRoute('blog.show', ['slug' => 'technikai-adossag-hogyan-legyenek-idotallo-it-rendszereink']) }}">
