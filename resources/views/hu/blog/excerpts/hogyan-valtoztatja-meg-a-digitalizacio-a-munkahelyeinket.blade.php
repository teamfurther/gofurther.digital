<div class="post">
    ...
    <div class="post__content">
        ...
        <p class="post__excerpt">
            Hogyan változtatja meg a digitális technológiák bevezetése a munkaerőt és hogyan tudnak ehhez alkalmazkodni a vállalkozások?
        </p>
        <a class="post__read-more" href="{{ localizedRoute('blog.show', ['slug' => 'hogyan-valtoztatja-meg-a-digitalizacio-a-munkahelyeinket']) }}">
            Tovább &raquo;
        </a>
    </div>
</div>